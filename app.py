...
# This work based on jQuery-File-Upload which can be found at https://github.com/ngoduykhanh/flask-file-uploader
...
app.config['DOWNLOAD_FOLDER'] = 'data/download/'
app.config['THUMBNAIL_FOLDER'] = 'data/thumbnail/'
app.config['MAX_CONTENT_LENGTH'] = 50 * 1024 * 1024

ALLOWED_EXTENSIONS = set(['rpt','txt', 'gif', 'png', 'jpg', 'jpeg', 'bmp', 'rar', 'zip', '7zip', 'doc', 'docx'])
...
def delete(filename):
    ...
    file_path2 = os.path.join(app.config['DOWNLOAD_FOLDER'], os.path.splitext(filename)[0]+'Final_Data.xlsx')
    # print(file_path2)
...
def get_file(filename):
    return send_from_directory(os.path.join(app.config['DOWNLOAD_FOLDER']), \
         filename=os.path.splitext(filename)[0]+'Final_Data.xlsx')
